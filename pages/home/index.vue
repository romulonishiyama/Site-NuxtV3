                    ...
                    <div class="col-md-4 p-6 ">
                        <div class="form-check">
                            <label class="form-check-label" for="categoria2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor"
                                    class="bi bi-alipay" viewBox="0 0 16 16" id="japones">
                                    <path
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <label class="form-check-label" for="categoria3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor"
                                    class="bi bi-cup-hot" viewBox="0 0 16 16" id="cafe">
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <label class="form-check-label" for="categoria4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor"
                                    class="bi bi-discord discorclass" viewBox="0 0 16 16" id="discord">
                                    <path
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <label class="form-check-label" for="categoria5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor"
                                    class="bi bi-whatsapp" viewBox="0 0 16 16" id="contato">
                                    <path
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <label class="form-check-label" for="categoria6">
                                <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor"
                                    class="bi bi-tsunami" viewBox="0 0 16 16" id="tsunami">
                                    <path
